...
//
//        ResponseEntity<UsuarioDto> response = clienteController._usuariosPost(usuarioDto);
//
...
//
//        ResponseEntity<UsuarioDto> response = clienteController._usuariosLoginGet("admin");
//
...
//                () -> clienteController._usuariosLoginGet(null)
//        );
//
...
//        CampoObrigatorioException exception = assertThrows(
//                CampoObrigatorioException.class,
//                () -> clienteController._usuariosLoginGet("   ")
//        );
//
//        assertEquals("login", exception.getMessage());
//    }
...
//        ResponseEntity<Void> response = clienteController._usuariosLoginDelete("admin");
//
...
//        CampoObrigatorioException exception = assertThrows(
//                CampoObrigatorioException.class,
//                () -> clienteController._usuariosLoginDelete("    ")
//        );
//    }
//}
