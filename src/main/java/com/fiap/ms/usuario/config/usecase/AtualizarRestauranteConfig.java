...
import com.fiap.ms.usuario.application.core.usecase.AtualizarRestauranteUseCase;
...
public class AtualizarRestauranteConfig {
    ...
    public AtualizarRestauranteUseCase atualizarRestauranteUseCase(BuscarRestauranteOutputPort buscarRestauranteOutputPort,
        ...
        return new AtualizarRestauranteUseCase(buscarRestauranteOutputPort, atualizarRestauranteUseCase);
    }
}
